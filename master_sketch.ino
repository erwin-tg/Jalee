...
void loop()
{
  ...
  //debut deposer poulet
    rotate(50, PWMRot);         // tourner ~45° = 250 pulse
    delay(300);

    driveForward(130, PWMPos);  // avancer 250 mm = 820 pulse
    delay(300);
    ...
    driveForward(-130, PWMPos);  // reculer 250 mm = -850 pulse
    delay(300);

    rotate(110, PWMRot);    // tourner 90° = 551 pulse
    delay(1500);
  ...
  // Se deplacer vers le cercle 2
    rotate(-45, PWMRot);    // tourner -90° = -220 pulse  
    delay(300);
    
    driveForward(1280, PWMDrive);  // avancer de 1288,8 mm = 6300 pulse
    delay(300);

    rotate(160, PWMRot);         // tourner ~135° = 825 pulse
    delay(300);

    call(Queue_battre);
    delay(30000);            // pause de 20s avant parcours bonus 

  // Parcour bonus
    rotate(-40, PWMRot);       // tourner -45° = -250 pulse
    delay(300);
  ...
  // Se deplacer vers le cercle 3
    ...
    rotate(125, PWMRot);        // tourner -135° = 500 pulse
    delay(300);

    rotate(410, PWMRot);      // tourner 360° = 2490 pulse
